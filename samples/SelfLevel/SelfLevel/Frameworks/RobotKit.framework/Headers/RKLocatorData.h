...
struct RKLocatorPosition {
    int16_t x; /*!< The x position of the locator (in cm) */
    int16_t y;  /*!< The y position of the locator (in cm) */
};
...
struct RKLocatorVelocity {
    int16_t x; /*!< The x velocity of the locator (in mm/s) */
    int16_t y;  /*!< The y velocity of the locator (in mm/s) */
};
...
/*! Read only property to access the locator x and y velocity (in mm/s) */
